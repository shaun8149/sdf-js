# Sprint 33 — a16z 20 篇对抗验证报告 (2026-07-07)

20 篇 a16z 文章摘录 (英文, 风格从数据密集报告到概念宣言) 打穿 news-to-deck 全链。
三路独立对抗检查: eval scorer / **number precision** (幻觉数字) / 全 subject 渲染冒烟。

**Summary**: 20 decks, 20/20 in [10,20] band, mean score 95.1, facts 99%, entities 92.5%, precision 90%, render failures 0
...
| defend-nation | 10 | ✓ | 92.9 | 100 | 100 | 80 | halluc: 20 |
| its-time-to-build | 13 | ✓ | 98.2 | 100 | 100 | 83 | halluc: 100 |
| genai-platform-value | 12 | ✓ | 96.4 | 100 | 0 | 83 | halluc: 85 $200B |
| enterprise-arms-race | 12 | ✓ | 96.4 | 100 | 100 | 84 | halluc: 19 0.46 0% 100% |
| app-spending | 10 | ✓ | 92.9 | 89 | 100 | 90 | halluc: 17 |
| gen-media-2026 | 13 | ✓ | 98.2 | 100 | 100 | 90 | halluc: 0.5 |
| raise-15b | 14 | ✓ | 100 | 100 | 100 | 92 | halluc: 3.3 |
...
| ai-compute-cost | 11 | ✓ | 94.6 | 100 | 100 | 100 |  |
| read-25-books | 12 | ✓ | 96.4 | 100 | 100 | 100 |  |
