...
export const SCAFFOLDS = [
  ...
  // ============================================================================
  {
    ...
    slots: [
      ...
      },
      {
        ...
        recommended_atoms: ['org-vs-org-matrix', 'pyramid', 'kpi-card', 'sphere-fill', 'bar'],
      },
      {
        name: 'solution',
        title: 'Our Solution',
  ...
  // ============================================================================
  {
    ...
    slots: [
      ...
      },
      {
        ...
        recommended_atoms: ['risk-heatmap', 'bullet-list', 'fishbone', 'waterfall'],
      },
      {
        name: 'outlook',
        title: 'Outlook',
        purpose: 'Forecast + next-Q targets',
        recommended_atoms: ['okr-tree', 'change-curve-chart', 'line', 'progression', 'kpi-card'],
      },
      {
        name: 'next-steps',
        title: 'Next Steps',
        purpose: 'Action items + owners + dates',
        recommended_atoms: ['kanban-board', 'bullet-list', 'timeline', 'gantt'],
      },
    ],
  ...
  // ============================================================================
  {
    ...
    slots: [
      ...
      },
      {
        ...
        recommended_atoms: ['risk-heatmap', 'fishbone', 'matrix-grid', 'bullet-list'],
      },
      {
        name: 'milestones',
        title: 'Milestones',
  ...
  // ============================================================================
  {
    ...
    slots: [
      ...
      },
      {
        ...
        recommended_atoms: ['okr-tree', 'radial-wheel-segmented', 'bullet-list', 'icon-badge'],
      },
      {
        name: 'key-results-1',
        title: 'Key Results',
      ...
      },
      {
        ...
        title: 'Objective',
        purpose: 'Aspirational, qualitative',
        recommended_atoms: ['okr-tree', 'bullet-list', 'icon-badge'],
      },
      {
        name: 'key-results-2',
        title: 'Key Results',
  ...
  // ============================================================================
  {
    ...
    slots: [
      ...
      },
      {
        ...
        recommended_atoms: ['journey-flow-curve', 'cover', 'kpi-card'],
      },
      {
        name: 'market-context',
        title: 'Market Context',
        purpose: 'Industry backdrop — size, trends, dynamics relevant to the buyer',
        recommended_atoms: ['org-vs-org-matrix', 'kpi-card', 'line', 'column', 'bar'],
      },
      {
        name: 'product',
  ...
  // ============================================================================
  {
    ...
    slots: [
      ...
      },
      {
        ...
        recommended_atoms: ['maturity-model', 'bullet-list', 'kpi-card', 'icon-grid'],
      },
      {
        name: 'problem-def',
      ...
      },
      {
        ...
        recommended_atoms: ['cost-benefit-matrix', 'bullet-list', 'kpi-card', 'line', 'bar'],
      },
      {
        name: 'framework',
        title: 'Framework',
  ...
  // ============================================================================
  {
    ...
    slots: [
      ...
      },
      {
        ...
        recommended_atoms: ['maturity-model', 'value-chain-diagram', 'pyramid', 'layer-stack'],
      },
      {
        name: 'data-findings',
        title: 'Data & Findings',
      ...
      },
      {
        ...
        recommended_atoms: ['balance-scale', 'bullet-list', 'quote-pull', 'kpi-card'],
      },
      {
        name: 'recommendations',
        title: 'Recommendations',
  ...
  },
  {
    ...
    slots: [
      ...
      },
      {
        ...
        recommended_atoms: ['maturity-model', 'bullet-list', 'kpi-card', 'swot'],
      },
      {
        name: 'target-state',
        title: 'Target State',
      ...
      },
      {
        ...
        recommended_atoms: ['risk-heatmap', 'swot', 'fishbone', 'bullet-list'],
      },
      {
        name: 'timeline',
        title: 'Delivery Timeline',
        purpose: 'Programme timeline with key deliverables and gates',
        recommended_atoms: ['kanban-board', 'timeline', 'progression', 'gantt'],
      },
    ],
  ...
  },
  {
    ...
    slots: [
      ...
      },
      {
        ...
        recommended_atoms: ['kanban-board', 'bullet-list', 'timeline', 'progression'],
      },
      {
        name: 'ask',
        title: 'Ask',
  ...
  },
  {
    ...
    slots: [
      ...
      },
      {
        ...
        recommended_atoms: ['testimonial-wall', 'quote-pull', 'bullet-list', 'icon-row'],
      },
      {
        name: 'channels',
        title: 'Channels',
  ...
  },
  {
    ...
    label: 'News Briefing',
    description:
      'News / current-events briefing — headline, key figures, per-theme deep dives, risk outlook. Sized for a 10-20 page deck expanded from a short article (Sprint 30).',
    audience: 'exec, analyst, general reader',
    keywords: [
      'news',
      'briefing',
      'article',
    ...
    slots: [
      {
        name: 'cover',
        title: 'Headline',
        purpose: 'Article headline + source and date context',
        recommended_atoms: ['cover'],
      },
      {
        name: 'agenda',
        title: 'Overview',
        purpose: 'One line per major theme of the briefing',
        recommended_atoms: ['agenda-list', 'number-list'],
      },
      {
        name: 'key-figures',
        title: 'Key Figures',
        purpose: 'The headline numbers at a glance',
        recommended_atoms: ['stat-grid-large', 'kpi-card', 'dashboard-multi-kpi-composite'],
      },
      {
        name: 'theme-1-lead',
        title: 'Theme 1 — Lead',
        purpose: 'First major theme: the core facts and figures',
        recommended_atoms: ['bar', 'column', 'stat-banner', 'kpi-card'],
      },
      {
        name: 'theme-1-detail',
        title: 'Theme 1 — Detail',
        purpose: 'First theme drill-down: regional / per-entity breakdown',
        recommended_atoms: ['bar', 'pie', 'segmented-bar', 'isotype-stat-comparison'],
      },
      {
        name: 'theme-2-lead',
        title: 'Theme 2 — Lead',
        purpose: 'Second major theme: the core facts',
        recommended_atoms: ['process-arrows', 'timeline', 'stat-banner', 'kpi-card'],
      },
      {
        name: 'theme-2-detail',
        title: 'Theme 2 — Detail',
        purpose: 'Second theme drill-down: sequence, conditions, thresholds',
        recommended_atoms: ['timeline', 'funnel-with-conversion', 'bullet-list', 'flow-chart'],
      },
      {
        name: 'theme-3-lead',
        title: 'Theme 3 — Lead',
      ...
      },
      {
        name: 'risk-matrix',
        title: 'Risk Matrix',
        purpose: 'Risks / scenarios on probability × impact axes',
        recommended_atoms: ['risk-heatmap', 'matrix-grid', 'swot'],
      },
      {
        name: 'risk-detail-1',
        title: 'Top Risk — Detail',
        purpose: 'The single highest-probability / highest-impact item, expanded',
        recommended_atoms: ['callout-banner', 'stat-with-icon', 'bullet-list'],
      },
      {
        name: 'risk-detail-2',
        title: 'Secondary Risks',
        purpose: 'Remaining risks / upside factors',
        recommended_atoms: ['balance-scale', 'icon-grid', 'bullet-list'],
      },
      {
        name: 'quote',
        title: 'Key Quote',
        purpose: 'A load-bearing quote or judgment from the article',
        recommended_atoms: ['quote-pull', 'pull-quote-banner'],
      },
      {
        name: 'outlook',
        title: 'Outlook',
        purpose: 'What to watch next — timeline or conditions',
        recommended_atoms: ['timeline', 'mountain-path', 'bullet-list'],
      },
      {
        name: 'summary',
        title: 'Summary',
        purpose: 'The whole briefing in 3-5 takeaways',
