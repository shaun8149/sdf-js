...
// Sprint 67: the pure numeric core moved to src/present/eval-core.js so the
// browser (author-2d quality lights) runs the SAME checks. Re-exported here
