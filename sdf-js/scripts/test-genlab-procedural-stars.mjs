...
ok(
  html.includes('starByRadius(5, r * 1.15)'),
  'morph star uses 5 points with scaled outer radius',
);
...
ok(!/[^A-Za-z0-9_$]star\(\s*0\.\d+\s*,\s*\d/.test(html), 'no literal-radius-first star calls remain');
