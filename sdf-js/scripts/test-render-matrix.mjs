...
ok(
  items.every((s) => s.animation && s.animation[0].channel === 'transform.translate.z'),
  'items animate along z',
);
ok(
  items.every((s) => /smoothstep\(/.test(s.animation[0].expr)),
  'slam uses smoothstep',
);
