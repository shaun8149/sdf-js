// =============================================================================
// pie-3d visual verify — 6 parametric variants
// =============================================================================
...
const panels = [
  {
    title: 'Default pie (5 slices, disc)',
    code: 'values:[0.3,0.2,0.15,0.2,0.15]',
    sdf: pie3dSDF(),
  },
  {
    title: 'Donut (innerR=0.5)',
    code: '{values:[25,25,25,25], innerR:0.5}',
    sdf: pie3dSDF({ values: [25, 25, 25, 25], innerRadius: 0.5 }),
  },
  {
    title: 'Thin ring (innerR=0.85)',
    code: '{innerR:0.85, thicker disc}',
    sdf: pie3dSDF({
      values: [25, 25, 25, 25],
      innerRadius: 0.85,
      thickness: 0.4,
  ...
  {
    title: 'Raw counts auto-normalized',
    code: '{values:[40,25,15,12,8]}',
    sdf: pie3dSDF({ values: [40, 25, 15, 12, 8] }),
  },
  {
    title: 'Thin coin (low thickness)',
    code: '{thickness:0.1}',
    sdf: pie3dSDF({ values: [30, 30, 20, 20], thickness: 0.1 }),
  },
  {
    title: 'Thick donut',
    code: '{innerR:0.4, thickness:0.7}',
    sdf: pie3dSDF({
      values: [1, 1, 1],
      outerRadius: 1.0,
      innerRadius: 0.4,
...
// Pie sits in XY plane — tilt so we see the top face + edge
