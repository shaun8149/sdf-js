...
const LAYER_DSEP = [0.03, 0.028, 0.018, 0.014, 0.022, 0.022, 0.022, 0.022, 0.02, 0.02, 0.02, 0.02];
...
document.getElementById('legend').innerHTML = sdfs
  .map((_, i) => {
