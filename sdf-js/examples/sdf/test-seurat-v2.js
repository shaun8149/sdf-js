...
const upperTorso = rounded_rectangle([0.17, 0.3], 0.07, [0, 0.22]);
...
const pelvicShelf = rounded_rectangle([0.18, 0.2], 0.08, [-0.02, -0.22]);
const buttocks = circle(0.1, [-0.14, -0.2]);
const pelvisBase = circle(0.08, [-0.02, -0.3]);
...
const elbow = circle(0.04, [0.095, 0.6]);
