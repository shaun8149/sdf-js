...
import { render, circle, rectangle, rounded_rectangle, polygon, union } from '../../src/index.js';
...
const hatBrim = rectangle([0.46, 0.035], [-0.1, 0.4]);
const hatCrown = rounded_rectangle([0.32, 0.32], [0.04, 0.04, 0, 0], [-0.1, 0.565]);
