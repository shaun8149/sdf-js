...
| `sphere-fill-3d` | capacity / fill-level gauges (% full, liquid below a waterline) | `levels[]` (0–1); **set `material.kind:"fill"` + liquid `hue`/`sat`/`value`** |
