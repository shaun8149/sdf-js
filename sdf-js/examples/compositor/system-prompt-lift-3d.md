...
`cube-3d` (cluster/grid/tower) · `sphere-fill-3d` / `-network-3d` / `-tree-3d` / `-segmented-3d` · `circle-frame-3d` / `-stack-3d` / `-segmented-3d` / `-loop-3d` · `arrow-3d` · `diamond-3d` · `gear-3d` · `cube-segmented-3d` · `puzzle-piece-3d`.
